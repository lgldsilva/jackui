...
- **Infra**: Docker no Raspberry Pi (context `raspberrypisrv`, IP `127.0.0.1`)
...
- Container: `jackett` no Raspberry Pi (`127.0.0.1`)
- Config em: `/Files/AppData/Config/Jackett/Jackett/ServerConfig.json`
