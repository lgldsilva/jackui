...
// writeFile writes data at path, creating parent dirs (test paths include
// per-user subdirs like alice/film.mkv). Replaces the pre-refactor package
// helper the dedup series relied on.
