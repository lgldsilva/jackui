...
func TestResolveTargetBase_Empty(t *testing.T) {
	base, err := httpshared.ResolveTargetBase("", "/shared", nil)
	if err != nil {
		t.Fatalf("httpshared.ResolveTargetBase: %v", err)
	}
	if base != "/shared" {
...
func TestResolveTargetBase_Matching(t *testing.T) {
	...
	base, err := httpshared.ResolveTargetBase("/extra", "/shared", dests)
	if err != nil {
		t.Fatalf("httpshared.ResolveTargetBase: %v", err)
	}
	if base != "/extra" {
...
func TestResolveTargetBase_NonMatching(t *testing.T) {
	_, err := httpshared.ResolveTargetBase("/invalid", "/shared", []httpshared.PromoteDest{{Name: "Lib", Path: "/shared"}})
	if err == nil {
...
func TestSanitizeSubdir_Empty(t *testing.T) {
	got, err := httpshared.SanitizeSubdir("")
	if err != nil {
		t.Fatalf("httpshared.SanitizeSubdir: %v", err)
	}
	if got != "" {
...
func TestSanitizeSubdir_Absolute(t *testing.T) {
	_, err := httpshared.SanitizeSubdir("/abs/path")
	if err == nil {
...
func TestSanitizeSubdir_Traversal(t *testing.T) {
	_, err := httpshared.SanitizeSubdir("../escape")
	if err == nil {
...
func TestSanitizeSubdir_Valid(t *testing.T) {
	got, err := httpshared.SanitizeSubdir("movies/2026")
	if err != nil {
		t.Fatalf("httpshared.SanitizeSubdir: %v", err)
	}
	if got != "movies/2026" {
...
func TestExtractLocalPromoteReq_Valid(t *testing.T) {
	...
	req, base, ok := extractLocalPromoteReq(c, b, "/shared", []httpshared.PromoteDest{{Name: "Bib", Path: "/shared"}})
	if !ok {
