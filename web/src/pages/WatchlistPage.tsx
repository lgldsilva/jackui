...
import { Bell, CalendarClock, Loader2, Plus, Trash2, Save, Copy, Clock, Play, Search, X } from 'lucide-react'
...
export default function WatchlistPage() {
  ...
  const schedSummary = (w: Watchlist): string => {
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-xs text-text-muted flex flex-wrap items-center gap-x-3 gap-y-1 mt-1">
                          ...
                          <span className="flex items-center gap-1 text-amber-400/90">
                            <CalendarClock className="w-3 h-3" /> {schedSummary(w)}
                          </span>
